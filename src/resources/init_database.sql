...
INSERT INTO product (id, name, default_price, currency_string, description, product_category, artist) VALUES (10, 'Marilyn', 8990, 'HUF', 'What else to say', 'Realistic', 'Pony Wave');
INSERT INTO product (id, name, default_price, currency_string, description, product_category, artist) VALUES (11, 'Toilet', 3990, 'HUF', 'Youre favorite spot on the world', 'Realistic', 'Pony Wave');
INSERT INTO product (id, name, default_price, currency_string, description, product_category, artist) VALUES (12, 'Twilight', 9990, 'HUF', 'Mr. Vampire himself on ouy', 'Realistic', 'Bang Bang');
INSERT INTO product (id, name, default_price, currency_string, description, product_category, artist) VALUES (13, 'Family Potrait', 19990, 'HUF', 'First is Family', 'Realistic', 'Little Johnny');
INSERT INTO product (id, name, default_price, currency_string, description, product_category, artist) VALUES (14, 'Drake', 3490, 'HUF', 'For true fans', 'Calligraphic', 'Little Johnny');
INSERT INTO product (id, name, default_price, currency_string, description, product_category, artist) VALUES (15, 'Spiderman', 5430, 'HUF', 'With great tatoo comes great responsibility', 'Realistic', 'Bang Bang');
INSERT INTO product (id, name, default_price, currency_string, description, product_category, artist) VALUES (16, 'Ninja Turtle', 6600, 'HUF', 'Not only for teenagers', 'Makeup', 'Pony Wave');
INSERT INTO product (id, name, default_price, currency_string, description, product_category, artist) VALUES (17, 'Great Heart', 10000, 'HUF', 'Perfect engagement gift', 'For Trve Lovers', 'Little Johnny');
INSERT INTO product (id, name, default_price, currency_string, description, product_category, artist) VALUES (18, 'WallMarkt', 6690, 'HUF', '10% OFF', 'Calligraphic', 'Little Johnny');
INSERT INTO product (id, name, default_price, currency_string, description, product_category, artist) VALUES (19, 'South Park', 15440, 'HUF', 'You killed Kenny', 'Calligraphic', 'Rit Kit Tattoo');
INSERT INTO product (id, name, default_price, currency_string, description, product_category, artist) VALUES (20, 'Monster', 3450, 'HUF', 'Show the ebast inside you', 'Calligraphic', 'Pony Wave');
