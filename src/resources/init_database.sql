...
INSERT INTO product (id, name, default_price, currency_string, description, product_category, artist) VALUES (21, 'Smile', 6660, 'HUF', 'Get the King of Pop on youre body', 'Famous People', 'Pony Wave');
INSERT INTO product (id, name, default_price, currency_string, description, product_category, artist) VALUES (22, 'Russian Standard', 6660, 'HUF', 'Get the King of Pop on youre body', 'Famous People', 'Pony Wave');
INSERT INTO product (id, name, default_price, currency_string, description, product_category, artist) VALUES (24, 'Disco Queen', 9990, 'HUF', 'Get the King of Pop on youre body', 'Famous People', 'Pony Wave');
INSERT INTO product (id, name, default_price, currency_string, description, product_category, artist) VALUES (25, 'Natural Look', 3490, 'HUF', 'Get the King of Pop on youre body', 'Famous People', 'Pony Wave');
INSERT INTO product (id, name, default_price, currency_string, description, product_category, artist) VALUES (26, 'EKIN', 3490, 'HUF', 'Get the King of Pop on youre body', 'Famous People', 'Pony Wave');
INSERT INTO product (id, name, default_price, currency_string, description, product_category, artist) VALUES (23, 'Babyboi', 5690, 'HUF', 'Get the King of Pop on youre body', 'Famous People', 'Pony Wave');
INSERT INTO product (id, name, default_price, currency_string, description, product_category, artist) VALUES (27, 'Twins', 5690, 'HUF', 'Get the King of Pop on youre body', 'Famous People', 'Pony Wave');
INSERT INTO product (id, name, default_price, currency_string, description, product_category, artist) VALUES (28, 'Babygurl', 5690, 'HUF', 'Get the King of Pop on youre body', 'Famous People', 'Pony Wave');
INSERT INTO product (id, name, default_price, currency_string, description, product_category, artist) VALUES (29, 'Pink Foyld', 5690, 'HUF', 'Get the King of Pop on youre body', 'Famous People', 'Pony Wave');
INSERT INTO product (id, name, default_price, currency_string, description, product_category, artist) VALUES (30, 'Mrs. Jolie', 5690, 'HUF', 'Get the King of Pop on youre body', 'Famous People', 'Pony Wave');
INSERT INTO product (id, name, default_price, currency_string, description, product_category, artist) VALUES (31, 'Hell of a Spite', 5690, 'HUF', 'Get the King of Pop on youre body', 'Famous People', 'Pony Wave');
